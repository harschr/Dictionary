...
public class Flashcards_HUPL extends javax.swing.JFrame {
    ...
    public Flashcards_HUPL(String category) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pn_flash_hupl = new javax.swing.JPanel();
        ...
        pn_flash_hupl.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "HU - PL words flashcards", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Georgia", 3, 16))); // NOI18N
        pn_flash_hupl.setLayout(new java.awt.CardLayout());
        ...
        pn_flash_hupl.add(pn_flash_hu, "card2");
        ...
        pn_flash_plLayout.setHorizontalGroup(
            ...
            .addGroup(pn_flash_plLayout.createSequentialGroup()
                ...
                .addContainerGap(25, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pn_flash_plLayout.createSequentialGroup()
        ...
        pn_flash_plLayout.setVerticalGroup(
            ...
            .addGroup(pn_flash_plLayout.createSequentialGroup()
                ...
                .addGroup(pn_flash_plLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bt_nextpair)
                    .addComponent(bt_back))
                .addGap(19, 19, 19))
        );

        pn_flash_hupl.add(pn_flash_pl, "card3");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(31, 31, 31)
                .addComponent(pn_flash_hupl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31))
        );
    ...
    private void pn_flash_huMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pn_flash_huMouseClicked
        CardLayout card = (CardLayout) pn_flash_hupl.getLayout();
        card.show(pn_flash_hupl, "card3");
    ...
    private void showQuestion() {
        ...
        lb_question.setText("<html>" + wordForTest.getMagyar() + "</html>");
    }

    private void showAnswer(Word wordForTest) {
        lb_answer.setText("<html>" + wordForTest.getPolski() + "</html>");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Flashcards_HUPL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel pn_flash_hupl;
